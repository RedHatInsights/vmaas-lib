...
func loadErrata(c *Cache) {
	...
	cols := "ID,name,synopsis,COALESCE(summary, ''),type,severity,COALESCE(description, ''),COALESCE(solution, ''),issued,COALESCE(updated, ''),url,third_party,requires_reboot" //nolint:lll,nolintlint
